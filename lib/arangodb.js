...
var ArangoDBConnector, Connector, GeoPoint, Sequence, _, _fieldIncluded, arangojs, async, debug, generateConnObject, initializeDataSource, merge, qb, qbTypes, url,
...
ArangoDBConnector = (function(superClass) {
  ...
  ArangoDBConnector.prototype._buildWhere = function(model, where, sequence) {
      ...
      return function() {
        ...
        if (condProp === 'and' || condProp === 'or' || condProp === 'nor') {
          if (Array.isArray(condValue)) {
            ...
            for (c in condValue) {
              a = condValue[c];
              cond = _this._buildWhere(model, a, sequence);
